  // Data pengukuran SO2 (contoh data)
  let measurements6 = [
    { time: '00:00', value: 10 },
    { time: '04:00', value: 15 },
    { time: '08:00', value: 12 },
  ...
  let ctx6 = document.getElementById('so2Chart').getContext('2d');

  // Membuat objek grafik dengan Chart.js
  let myChart6 = new Chart(ctx6, {
    type: 'line',
    data: {
      labels: measurements6.map(entry => entry.time), // Waktu pengukuran
      datasets: [{
        label: 'SO2',
        data: measurements6.map(entry => entry.value), // Nilai SO2
